...
function AppContent() {
  ...
  return <div className="w-full min-h-screen bg-gray-50">
      ...
      {currentView === 'home' && isAuthenticated && <Home onCookWithWhatIHave={navigateToSuggestions} onViewCalendar={navigateToCalendar} onManagePantry={navigateToPantryManager} onQuickLog={navigateToQuickLog} onShoppingList={navigateToShoppingList} onRecipeManager={navigateToRecipeManager} onSettings={navigateToSettings} />}
      ...
      {currentView === 'pantryManager' && isAuthenticated && <PantryManager onBack={navigateToHome} onShoppingList={navigateToShoppingList} />}
